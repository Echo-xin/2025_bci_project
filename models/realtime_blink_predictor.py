...
if __name__ == "__main__":
    ...
    app = RealTimeBlinkVisualizer(
        root,
        stage1_model_path="../models/blink_detector.pkl",
        stage1_label_path="../models/blink_detector_labels.pkl",
        stage2_model_path="../models/blink_type_classifier.pkl",
        stage2_label_path="../models/blink_type_labels.pkl"
    )
    root.mainloop()
